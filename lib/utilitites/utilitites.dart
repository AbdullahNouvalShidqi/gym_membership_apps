...
class Utilities{
  ...
  static const TextStyle signInSignUpMainTitleStyle = TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: primaryColor);

  static const TextStyle homeViewMainTitleStyle = TextStyle(fontSize: 32, fontWeight: FontWeight.w700, color: Colors.black);
  ...
  static const TextStyle personalDetailLabel = TextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: Utilities.primaryColor);
